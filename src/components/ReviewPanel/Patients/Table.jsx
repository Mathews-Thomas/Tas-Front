...
import Patient_Model from "./PatientPreviewModal";
import ProgressBar from "../../common/ProgressBar/ProgressBar";

import { GrFormView } from "react-icons/gr";

/* eslint-disable react/prop-types */
const PatientList = ({ data, BranchID, fetchData, loader }) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3 px-6 flex justify-center items-center">
                    <Link
                      to={`/review-panel/patient-invoice/?BranchID=${BranchID}&PatientID=${patient?.PatientID}`}
                    >
                  ...
                  {/* <button className="hover:bg-gray-300 ml-8 "> */}
                  <td>
                  {/* <Link
                    to={{
                      pathname: `/Patient-Profile/${patient?.PatientID}`,
                      search: `?BranchID=${BranchID}&PatientID=${patient?.PatientID}`,
                      state: { patient }
                    }}
                    className="px-4 py-2  hover:bg-[#387ADF]  font-bold rounded shadow-lg transition duration-300 ease-in-out transform hover:scale-105 flex gap-2 items-center justify-center"
                  >
