...
import MedicineInvoiceEditPage from "./editInvoice";
import InvoiceEditPage from "./editInvoice";
const Medicine_Invoive_Edit_Modal = ({
  showEditModal,
  fetchData,
  setShowEditModal,
  invoice,
    ...
    <div>
      {showEditModal ? (
        <>
          ...
          >
            <div
              className="relative w-full my-6 mx-auto max-w-custom h-[90%]"
...
export default Medicine_Invoive_Edit_Modal;
